...
a();
$BOT_USERNAME = 'custom_freeman_bot';
$BOT_TOKEN = '5793129764:AAGR9DRRbMjBl4Byei70Sec6OiqAfuwdQRw';
$REDIRECT_URI = 'https://server4reema.vps.webdock.cloud/';
?>
...
<head>
    ...
    <script async src="https://telegram.org/js/telegram-widget.js?14" data-telegram-login="<?= $BOT_USERNAME ?>" data-size="medium" data-auth-url="<?= $REDIRECT_URI ?>" data-request-access="write"></script>
</head>
<body>
<div class='main'>
