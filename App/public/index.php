...
<head>
    ...
    <script async src="https://telegram.org/js/telegram-widget.js?21" data-telegram-login="<?= $BOT_USERNAME ?>" data-size="medium" data-auth-url="<?= $REDIRECT_URI ?>" data-request-access="write"></script>
</head>
<body>
<div class='main'>
